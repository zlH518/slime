...
RUNTIME_ENV_JSON="{
  \"env_vars\": {
    ...
    \"WANDB_MODE\": \"offline\",
    \"WANDB_DIR\": \"/volume/pt-train/users/mingjie/hzl_code/code/slime/scripts/0812/4B/2/wandb\",
    \"LOG_DIR\": \"/volume/pt-train/users/mingjie/hzl_code/code/slime/scripts/0812/4B/2/log\",
    \"PERF_DIR\": \"/volume/pt-train/users/mingjie/hzl_code/code/slime/scripts/0812/4B/2\"
  }
}"
