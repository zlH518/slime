...
CKPT_ARGS=(
   ...
   --load /volume/pt-train/users/mingjie/hzl_code/code/slime/experiments/slime_qwen2.4_7b_2task
...
ROLLOUT_ARGS=(
   ...
   --rollout-max-prompt-len 1500
   --rollout-max-response-len 2500
...
RUNTIME_ENV_JSON="{
  \"env_vars\": {
    ...
    \"WANDB_MODE\": \"offline\",
    \"WANDB_DIR\": \"/volume/pt-train/users/mingjie/hzl_code/code/slime/scripts/0808/13/wandb\",
    \"LOG_DIR\": \"/volume/pt-train/users/mingjie/hzl_code/code/slime/scripts/0808/13/log\"
  }
}"
