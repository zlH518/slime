...
RUNTIME_ENV_JSON="{
  \"env_vars\": {
    ...
    \"WANDB_MODE\": \"offline\",
    \"WANDB_DIR\": \"/volume/pt-train/users/mingjie/hzl_code/code/slime/scripts/0808/2/wandb\",
    \"LOG_DIR\": \"/volume/pt-train/users/mingjie/hzl_code/code/slime/scripts/0808/2/log\"
  }
}"
