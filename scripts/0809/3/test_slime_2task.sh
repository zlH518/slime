...
pip install --no-build-isolation --no-deps -e /volume/pt-train/users/mingjie/hzl_code/code/SourceCode/slime
...
CKPT_ARGS=(
   ...
   --load /volume/pt-train/users/mingjie/hzl_code/code/slime/experiments/slime_qwen2.4_7b_1task
...
RUNTIME_ENV_JSON="{
  \"env_vars\": {
    ...
    \"WANDB_MODE\": \"offline\",
    \"WANDB_DIR\": \"/volume/pt-train/users/mingjie/hzl_code/code/slime/scripts/0809/2/wandb\",
    \"LOG_DIR\": \"/volume/pt-train/users/mingjie/hzl_code/code/slime/scripts/0809/2/log\"
  }
}"

ray job submit --address="http://127.0.0.1:8265" \
   --runtime-env-json="${RUNTIME_ENV_JSON}" \
   -- python3 /volume/pt-train/users/mingjie/hzl_code/code/SourceCode/slime/train.py \
   --actor-num-nodes 1 \
