...
CKPT_ARGS=(
   ...
   --load /volume/pt-train/users/mingjie/hzl_code/code/slime/experiments/slime_qwen2.5_7b_2task
   --save /volume/pt-train/users/mingjie/hzl_code/code/slime/experiments/slime_qwen2.5_7b_2task
   --save-interval 20
)
...
ray start --head --node-ip-address ${MASTER_ADDR} --num-gpus 3 --disable-usage-stats
...
RUNTIME_ENV_JSON="{
  \"env_vars\": {
    ...
    \"WANDB_MODE\": \"offline\",
    \"WANDB_DIR\": \"/volume/pt-train/users/mingjie/hzl_code/code/slime/scripts/0801/5/wandb\",
    \"LOG_DIR\": \"/volume/pt-train/users/mingjie/hzl_code/code/slime/scripts/0801/5/log\"
  }
}"
