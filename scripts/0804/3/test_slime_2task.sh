...
RUNTIME_ENV_JSON="{
  \"env_vars\": {
    ...
    \"WANDB_MODE\": \"offline\",
    \"WANDB_DIR\": \"/volume/pt-train/users/mingjie/hzl_code/code/slime/scripts/0804/3/wandb\",
    \"LOG_DIR\": \"/volume/pt-train/users/mingjie/hzl_code/code/slime/scripts/0804/3/log\"
  }
}"
